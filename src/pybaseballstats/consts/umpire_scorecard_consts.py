...
UMPIRE_SCORECARDS_PLAYERS_URL = "https://umpscorecards.com/api/players?playerType={player_type}&startDate={start_date}&endDate={end_date}&seasonType={game_type}&team={team}"
